...
function setup() {
  ...
  obstacles = createSprite(320,530,50,100)
  obstacles.addImage(obstacle_img)
  obstacles.scale = 0.5
  obstacles.setCollider("rectangle",0,100,300,300)
   
  lz=createSprite(880,610,300,30)
    lz.addImage(lz_img)
    lz.scale = 0.3
...
function draw() 
{
  ...
  if (lander.collide(obstacles)==true) {
...
if (lander.collide(gro+und)==true) {
  lander.changeAnimation("crashing")
  vx=0
  vy=0
  g=0
